...
CREATE TABLE IF NOT EXISTS `stakloram2022`.`buyer` (
  ...
  `buyer_jbkjs` VARCHAR(145) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `stakloram2022`.`user` (
  ...
  `user_display_name` VARCHAR(145) NULL DEFAULT NULL,
  `user_username` VARCHAR(145) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `stakloram2022`.`history` (
  ...
  `history_previous_value` VARCHAR(10000) NULL DEFAULT NULL,
  `history_new_value` VARCHAR(10000) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `stakloram2022`.`work_order` (
  ...
  `work_order_number` INT(11) NULL DEFAULT NULL,
  `work_order_date_of_create` DATE NULL DEFAULT NULL,
  `work_order_place_of_issue` VARCHAR(145) NULL DEFAULT NULL,
  `work_order_for_person` VARCHAR(145) NULL DEFAULT NULL,
  `work_order_description` VARCHAR(3045) NULL DEFAULT NULL,
  `work_order_note` VARCHAR(3045) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `stakloram2022`.`image` (
  ...
  `image_work_order_work_order_id` INT(11) NOT NULL,
  PRIMARY KEY (`image_id`),
  INDEX `fk_image_work_order1_idx` (`image_work_order_work_order_id` ASC) VISIBLE,
  CONSTRAINT `fk_image_work_order1`
    FOREIGN KEY (`image_work_order_work_order_id`)
...
CREATE TABLE IF NOT EXISTS `stakloram2022`.`invoice` (
  ...
  `invoice_method_of_payment` VARCHAR(45) NULL DEFAULT NULL,
  `invoice_comment` VARCHAR(4000) NULL DEFAULT NULL,
  `invoice_net_amount` DECIMAL(20,2) NULL DEFAULT NULL,
  `invoice_vat_rate` DECIMAL(20,2) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `stakloram2022`.`note`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `stakloram2022`.`note` ;

CREATE TABLE IF NOT EXISTS `stakloram2022`.`note` (
  `note_id` INT(11) NOT NULL AUTO_INCREMENT,
  `note_name` VARCHAR(545) NULL DEFAULT NULL,
  `note_description` VARCHAR(545) NULL DEFAULT NULL,
  `note_invoice_invoice_id` INT(11) NOT NULL,
  PRIMARY KEY (`note_id`),
  INDEX `fk_note_invoice1_idx` (`note_invoice_invoice_id` ASC) VISIBLE,
  CONSTRAINT `fk_note_invoice1`
    FOREIGN KEY (`note_invoice_invoice_id`)
    REFERENCES `stakloram2022`.`invoice` (`invoice_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `stakloram2022`.`work_order_item` (
  ...
  `work_order_item_uom` VARCHAR(50) NOT NULL,
