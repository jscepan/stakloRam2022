package com.stakloram.application.services.impl.builder;
...
public abstract class BaseBuilder implements IObjectBuilder {
    ...
    public String generateWhereClausule(String whereClausule, String searchClausule, String equalsClausule, String containsClausule) {
        String where = "";
